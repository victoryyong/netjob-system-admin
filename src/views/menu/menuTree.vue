  ...
  <el-table  
    ...
    <el-table-column label="操作" v-if="treeType === 'normal'" width="220">
      <template scope="scope">  
        ...
        <el-button   :disabled="addOprt||scope.row._level===1" @click="handleAdd(scope.row.id,scope.row.type,scope.row)" class="el-button el-button--success el-button--small">
            添加下级
        </el-button>  
      </template>  
    </el-table-column>  
...
// 是否默认展开所有树  
    ...
    // 格式化数据源  
      ...
      editOprt:function(){
        return !util.hasOprt(this,'admin.menu.edit');
      },
      deleteOprt:function(){
        return !util.hasOprt(this,'admin.menu.delete');
      } 
    },  
    methods: {
